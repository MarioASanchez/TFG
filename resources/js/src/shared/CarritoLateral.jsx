        ...
        <div className="offcanvas offcanvas-end bg-dark text-white" tabIndex="-1" id="offcanvasCarrito" aria-labelledby="offcanvasCarritoLabel">
            ...
            <div className="offcanvas-body">
                {cart.length === 0 ? (
                    ...
                    <>
                        {cart.map((item) => (
                            <div key={item.id} className="card-dark p-3 mb-3 shadow-sm">
                                <div className="d-flex align-items-center mb-3">
                                    ...
                                    <div className="flex-grow-1 min-width-0">
                                        ...
                                        <span className="text-purple fw-bold" style={{fontSize: '0.85rem'}}>{item.precio}€</span>
                                    </div>
                                    <button className="btn btn-sm btn-outline-danger border-0 p-1 ms-2" onClick={() => removeFromCart(item.id)}>
                                ...
                                <div className="d-flex justify-content-between align-items-center bg-dark bg-opacity-50 p-2 rounded shadow-inner">
                                    ...
                                    <div className="d-flex align-items-center ms-auto">
                                        <button className="btn btn-sm btn-link text-white p-0 text-decoration-none bg-white bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style={{width: '24px', height: '24px'}} onClick={() => updateQuantity(item.id, item.cantidad - 1)}>-</button>
